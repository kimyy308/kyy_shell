...
SRCROOT=${SRCROOT:-"/cluster/projects/${PROJECT}/${USER}/NORESM/NorESM2/src_exp/NorESM-AERA_T"}
CASEROOT=${CASEROOT:-"/cluster/projects/${PROJECT}/${USER}/NORESM/NorESM2/cases"}
