...
set SAVE_Y_ROOT = /mnt/lustre/proj/earth.system.predictability/LENS2/archive_yearly_transfer/atm/${var}/corr
mkdir -p \$SAVE_Y_ROOT
# all_det
...
foreach caseloop (\`seq 1 \${ncase1}\` )
  ...
  set file1 = \${ARC_Y_ROOT}/\${case1}/merged/${var}_yearly_det_\${RESOLN}.lens2.\${case1}.cam.h0.nc
  @ ncase2 = \${caseloop} + 1
  foreach caseloop2 (\`seq \${ncase2} \${#CASENAME_SET}\` )
    @ NOC = \${NOC} + 1
    set case2 = \${CASENAME_SET[\$caseloop2]}
    set file2 = \${ARC_Y_ROOT}/\${case2}/merged/${var}_yearly_det_\${RESOLN}.lens2.\${case2}.cam.h0.nc
...
set SAVE_Y_ens_ROOT = /mnt/lustre/proj/earth.system.predictability/LENS2/archive_yearly_transfer/atm/${var}/corr/ens
