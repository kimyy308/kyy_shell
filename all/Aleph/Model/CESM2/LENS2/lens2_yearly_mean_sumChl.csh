...
mkdir ~/tmp_script
mkdir ~/tmp_log
set tmp_scr =  ~/tmp_script/yearly_${var}_lens2_tmp.csh
set tmp_log =  ~/tmp_log/yearly_${var}_lens2_tmp.log
...
set ARC_Y_ROOT = /mnt/lustre/proj/earth.system.predictability/LENS2/archive_yearly_transfer/ocn/${var}
  set SAVE_ROOT = \${ARC_ROOT}/ens_smbb
...
foreach INITY ( \${Y_SET} )
  cdo -O -w -z zip_5 -ensmean \${SAVE_ROOT}/${var}_ensmean_\${INITY}-*.nc \${SAVE_Y_ROOT}/${var}_y_ensmean_\${INITY}.nc
end
