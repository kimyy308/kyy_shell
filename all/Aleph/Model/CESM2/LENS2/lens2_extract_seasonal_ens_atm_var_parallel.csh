...
foreach yloop ( \${Y_SET} )
  foreach season ( \${seasons} )
    ...
    cd \${ARC_ROOT}
    set ENS = ens_smbb
    set SAVE_ROOT = /mnt/lustre/proj/earth.system.predictability/LENS2/archive_seasonal_transfer/atm/${var}/\${ENS}/\${season}
    mkdir -p \$SAVE_ROOT
    set FILE_ROOT = \${ARC_ROOT}/atm/${var}/\${ENS}/\${season_o}
    echo \${FILE_ROOT}
