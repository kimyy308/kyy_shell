...
#20240107
set vars = ( TS )
#set vars = ( SSH TEMP SALT UVEL VVEL PD DIC ALK WVEL diatChl diazChl spChl diatC diazC spC Fe NO3 NH4 SiO3 PO4 DOP PAR_avg zooC photoC_TOT pH_3D FG_CO2 DpCO2) not yet

set vars = ( SST PRECT PSL ) #atm
set vars = ( GPP TOTVEGC TWS COL_FIRE_CLOSS FAREA_BURNED SOILWATER_10CM TLAI )
#20240110
set vars = ( photoC_TOT_zint_100m )
#20240115
set vars = ( SSH PSL AEROD_v )
set vars = ( PSL AEROD_v )

set comp = atm ## please set
...
foreach smbbnum ( \${smbb_set} )
  ...
  foreach period ( \${period_set_hist} )
    set inputname = \${ARC_ROOT}/\${smbbnum}/${comp}/proc/tseries/month_1/*.${fmid}${var}.\${period}.nc
    set SAVE_ROOT_smbb = /mnt/lustre/proj/earth.system.predictability/regrid_5deg/LENS2_5deg/archive/\${smbbnum}/${comp}/proc/tseries/month_1
    mkdir -p \$SAVE_ROOT_smbb
    set outputname = \${SAVE_ROOT_smbb}/\${smbbnum}.r72x36.${fmid}${var}.\${period}.nc
    cdo -O -w -select,name=${var} \${inputname} ${homedir}/lens2_test_5deg_${var}.nc
    cdo -O -w -z zip_5 -remapbil,r72x36  ${homedir}/lens2_test_5deg_${var}.nc \${outputname}
  end
end
