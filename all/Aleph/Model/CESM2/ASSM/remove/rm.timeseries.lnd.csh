...
set mem = `cat mem_name`
  ...
  foreach vname1 ( $vnames1 )
   rm -f  /mnt/lustre/proj/earth.system.predictability/ASSM_EXP_timeseries/ASSM_EXP_fixed/archive/*f09_g17.assm.${mem}/lnd/proc/tseries/day_1/*.$vname1.*.nc
  end
  ...
  foreach vname2 ( $vnames2 )
   rm -f  /mnt/lustre/proj/earth.system.predictability/ASSM_EXP_timeseries/ASSM_EXP_fixed/archive/*f09_g17.assm.${mem}/lnd/proc/tseries/month_1/*.$vname2.*.nc
  end
  ...
  foreach vname3 ( $vnames3 )
     rm -f  /mnt/lustre/proj/earth.system.predictability/ASSM_EXP_timeseries/ASSM_EXP_fixed/archive/*f09_g17.assm.${mem}/lnd/proc/tseries/month_1/*.$vname3.*.nc
  end
  ...
  foreach vname4 ( $vnames4 )
     rm -f  /mnt/lustre/proj/earth.system.predictability/ASSM_EXP_timeseries/ASSM_EXP_fixed/archive/*f09_g17.assm.${mem}/lnd/proc/tseries/month_1/*.$vname4.*.nc
  end
  ...
  foreach vname5 ( $vnames5 )
     rm -f  /mnt/lustre/proj/earth.system.predictability/ASSM_EXP_timeseries/ASSM_EXP_fixed/archive/*f09_g17.assm.${mem}/lnd/proc/tseries/month_1/*.$vname5.*.nc
  end
