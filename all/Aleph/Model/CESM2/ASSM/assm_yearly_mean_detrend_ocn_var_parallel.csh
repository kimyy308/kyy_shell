...
set tmp_log =  ~/tmp_log/yearly_det_${var}_assm_tmp.log
...
foreach CASENAME ( \${CASENAME_SET} )
  ...
  mkdir -p \$SAVE_ROOT
  mkdir -p \$SAVE_Y_ROOT
#  cdo -O -w -z zip_5 -yearmean \${SAVE_ROOT}/${var}_\${RESOLN}.assm.\${CASENAME}.pop.h.nc \${SAVE_Y_ROOT}/${var}_yearly_\${RESOLN}.assm.\${CASENAME}.pop.h.nc
  cdo -O -w -z zip_5 -timselmean,12,0,0 \${SAVE_ROOT}/${var}_\${RESOLN}.assm.\${CASENAME}.pop.h.nc \${SAVE_Y_ROOT}/${var}_yearly_\${RESOLN}.assm.\${CASENAME}.pop.h.nc
#  ncap2 -O -w -z zip_5 -s 'where(time==715581) {time=715566;}' \${SAVE_Y_ROOT}/${var}_yearly_\${RESOLN}.assm.\${CASENAME}.pop.h.nc \${SAVE_Y_ROOT}/${var}_yearly_\${RESOLN}.assm.\${CASENAME}.pop.h.nc
  cdo -O -w -z zip_5 -detrend \${SAVE_Y_ROOT}/${var}_yearly_\${RESOLN}.assm.\${CASENAME}.pop.h.nc \${SAVE_Y_ROOT}/${var}_yearly_det_\${RESOLN}.assm.\${CASENAME}.pop.h.nc
