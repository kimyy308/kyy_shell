...
set SAVE_ROOT = /mnt/lustre/proj/kimyy/Model/CESM2/ESP/ASSM_EXP/archive_Nor/ocn/ens_all
mkdir -p \$SAVE_ROOT
set CASENAME_SET = ( \`ls \${ARC_ROOT}/*/merged/*projd*.nc\` )

cdo -z zip_5 -O -ensmean \${CASENAME_SET} \${SAVE_ROOT}/${var}_ensmean.nc
#cdo -O -ensmean \${CASENAME_SET} /proj/kimyy/tmp/${var}_ensmean.nc
#cdo -O -ensmean /proj/kimyy/tmp/${var}_ensmean.nc \${SAVE_ROOT}/${var}_ensmean.nc
