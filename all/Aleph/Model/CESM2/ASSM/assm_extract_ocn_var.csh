          ...
          foreach period ( ${period_SET} )
            ...
            if ($Y_1 <= ${yloop} && ${yloop} <= $Y_2) then
              ...
              foreach mloop ( ${M_SET} )
                ...
                #ls $input_head
                cdo -O -w -seltimestep,$tind2 $inputname /proj/kimyy/test_${var}.nc
                cdo -O -w -select,name=${var} /proj/kimyy/test_${var}.nc /proj/kimyy/test2_${var}.nc
                cdo -O -w -sellevel,500/15000 /proj/kimyy/test2_${var}.nc $outputname 
                echo ${outputname}
              end
            endif
          end 
