...
#      set CASENAME_M = b.e21.${scen}.${RESOLN}.assm.${OBS}-${FACTOR}p${mbr}  #parent casename
      ...
      #diatChl
      set ARC_ROOT_diat = /mnt/lustre/proj/earth.system.predictability/ATM_TEST/EXP_ATM/archive_transfer/ocn/${outfreq}/diatChl/${CASENAME}
      ...
      #diazChl
      set ARC_ROOT_diaz = /mnt/lustre/proj/earth.system.predictability/ATM_TEST/EXP_ATM/archive_transfer/ocn/${outfreq}/diazChl/${CASENAME}
      ...
      #spChl
      set ARC_ROOT_sp = /mnt/lustre/proj/earth.system.predictability/ATM_TEST/EXP_ATM/archive_transfer/ocn/${outfreq}/spChl/${CASENAME}
      ...
      #sumChl
      set ARC_ROOT_sum = /mnt/lustre/proj/earth.system.predictability/ATM_TEST/EXP_ATM/archive_transfer/ocn/${outfreq}/sumChl/${CASENAME}
