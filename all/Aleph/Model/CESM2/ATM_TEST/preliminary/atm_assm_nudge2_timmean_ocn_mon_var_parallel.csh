...
#      set ARC_ROOT = /mnt/lustre/proj/earth.system.predictability/ATM_TEST/preliminary/ATM_NUDGE2_ASSM_EXP/archive/\${CASENAME_M}
      set ARC_ROOT = /mnt/lustre/proj/earth.system.predictability/ATM_TEST/preliminary/ATM_NUDGE2_ASSM_EXP/archive_transfer/ocn/\${outfreq}/${var}/\${CASENAME} 
      set SAVE_ROOT = /mnt/lustre/proj/earth.system.predictability/ATM_TEST/preliminary/ATM_NUDGE2_ASSM_EXP/archive_transfer/ocn/\${outfreq}/${var}/\${CASENAME}/MEAN
      set SAVE_RMSE_ROOT = /mnt/lustre/proj/earth.system.predictability/ATM_TEST/preliminary/ATM_NUDGE2_ASSM_EXP/archive_transfer/ocn/\${outfreq}/${var}/\${CASENAME}/RMSE
      mkdir -p \$SAVE_ROOT
      ...
      set OBS_SAVE_ROOT = /mnt/lustre/proj/earth.system.predictability/ATM_TEST/preliminary/ATM_ASSM_EXP/archive_transfer/ocn/\${outfreq}/${var}/\${OBS_CASENAME}/MEAN
      set OBS_SAVE_RMSE_ROOT = /mnt/lustre/proj/earth.system.predictability/ATM_TEST/preliminary/ATM_ASSM_EXP/archive_transfer/ocn/\${outfreq}/${var}/\${OBS_CASENAME}/RMSE
      ...
      cdo -O -w -z zip_5  -sellonlatbox,0,360,70,90 \${merge_file} ${homedir}/test_NUDGE2_selbox_${var}.nc
      cdo -O -w -z zip_5 -fldmean ${homedir}/test_NUDGE2_selbox_${var}.nc \${ATO_file}
      
      #SubPolar North Pacific 120E ~ 240E(120W), 40N ~ 70N
      set SPNP_file = \${SAVE_ROOT}/mean_SPNP_${var}_\${CASENAME}.pop.h.nc
      cdo -O -w -z zip_5  -sellonlatbox,120,240,40,70 \${merge_file} ${homedir}/test_NUDGE2_selbox_${var}.nc
      cdo -O -w -z zip_5 -fldmean ${homedir}/test_NUDGE2_selbox_${var}.nc \${SPNP_file}

      #SubTropical North Pacific 100E ~ 260E(100W), 20N ~ 40N
      set STNP_file = \${SAVE_ROOT}/mean_STNP_${var}_\${CASENAME}.pop.h.nc
      cdo -O -w -z zip_5  -sellonlatbox,100,260,20,40 \${merge_file} ${homedir}/test_NUDGE2_selbox_${var}.nc
      cdo -O -w -z zip_5 -fldmean ${homedir}/test_NUDGE2_selbox_${var}.nc \${STNP_file}

      #Tropical Pacific 120E ~ 280E(100W), -20N ~ 20N
      set TP_file = \${SAVE_ROOT}/mean_TP_${var}_\${CASENAME}.pop.h.nc
      cdo -O -w -z zip_5  -sellonlatbox,120,280,-20,20 \${merge_file} ${homedir}/test_NUDGE2_selbox_${var}.nc
      cdo -O -w -z zip_5 -fldmean ${homedir}/test_NUDGE2_selbox_${var}.nc \${TP_file}

      #SubTropical South Pacific 140E ~ 290E(70W), -40N ~ -20N
      set STSP_file = \${SAVE_ROOT}/mean_STSP_${var}_\${CASENAME}.pop.h.nc
      cdo -O -w -z zip_5  -sellonlatbox,140,290,-40,-20 \${merge_file} ${homedir}/test_NUDGE2_selbox_${var}.nc
      cdo -O -w -z zip_5 -fldmean ${homedir}/test_NUDGE2_selbox_${var}.nc \${STSP_file}

      #SubPolar South Pacific 140E ~ 290E(70W), -60N ~ -40N
      set SPSP_file = \${SAVE_ROOT}/mean_SPSP_${var}_\${CASENAME}.pop.h.nc
      cdo -O -w -z zip_5  -sellonlatbox,140,290,-60,-40 \${merge_file} ${homedir}/test_NUDGE2_selbox_${var}.nc
      cdo -O -w -z zip_5 -fldmean ${homedir}/test_NUDGE2_selbox_${var}.nc \${SPSP_file}

      #ANtarctic Ocean 0E ~ 360E(0W), -80N ~ -60N
      set ANO_file = \${SAVE_ROOT}/mean_ANO_${var}_\${CASENAME}.pop.h.nc
      cdo -O -w -z zip_5  -sellonlatbox,0,360,-80,-60 \${merge_file} ${homedir}/test_NUDGE2_selbox_${var}.nc
      cdo -O -w -z zip_5 -fldmean ${homedir}/test_NUDGE2_selbox_${var}.nc \${ANO_file}

      #SubPolar North Atlantic 260E(100W) ~ 360E(0W), 40N ~ 70N
      set SPNA_file = \${SAVE_ROOT}/mean_SPNA_${var}_\${CASENAME}.pop.h.nc
      cdo -O -w -z zip_5  -sellonlatbox,260,360,40,70 \${merge_file} ${homedir}/test_NUDGE2_selbox_${var}.nc
      cdo -O -w -z zip_5 -fldmean ${homedir}/test_NUDGE2_selbox_${var}.nc \${SPNA_file}

      #SubTropical North Atlantic 260E(100W) ~ 360E(0W), 20N ~ 40N
      set STNA_file = \${SAVE_ROOT}/mean_STNA_${var}_\${CASENAME}.pop.h.nc
      cdo -O -w -z zip_5  -sellonlatbox,260,360,20,40 \${merge_file} ${homedir}/test_NUDGE2_selbox_${var}.nc
      cdo -O -w -z zip_5 -fldmean ${homedir}/test_NUDGE2_selbox_${var}.nc \${STNA_file}

      #Tropical Atlantic 280E(80W) ~ 20E, -20N ~ 20N
      set TA_file = \${SAVE_ROOT}/mean_TA_${var}_\${CASENAME}.pop.h.nc
      cdo -O -w -z zip_5  -sellonlatbox,-80,20,-20,20 \${merge_file} ${homedir}/test_NUDGE2_selbox_${var}.nc
      cdo -O -w -z zip_5 -fldmean ${homedir}/test_NUDGE2_selbox_${var}.nc \${TA_file}
      
      #SubTropical South Atlantic 300E(60W) ~ 20E, -40N ~ -20N
      set STSA_file = \${SAVE_ROOT}/mean_STSA_${var}_\${CASENAME}.pop.h.nc
      cdo -O -w -z zip_5  -sellonlatbox,-60,20,-40,-20 \${merge_file} ${homedir}/test_NUDGE2_selbox_${var}.nc
      cdo -O -w -z zip_5 -fldmean ${homedir}/test_NUDGE2_selbox_${var}.nc \${STSA_file}

      #SubPolar South Atlantic 290E(-70W) ~ 20E, -60N ~ -40N
      set SPSA_file = \${SAVE_ROOT}/mean_SPSA_${var}_\${CASENAME}.pop.h.nc
      cdo -O -w -z zip_5  -sellonlatbox,-70,20,-60,-40 \${merge_file} ${homedir}/test_NUDGE2_selbox_${var}.nc
      cdo -O -w -z zip_5 -fldmean ${homedir}/test_NUDGE2_selbox_${var}.nc \${SPSA_file}

      #Northern Indian Ocean 40E ~ 100E, -10N ~ 30N
      set NIO_file = \${SAVE_ROOT}/mean_NIO_${var}_\${CASENAME}.pop.h.nc
      cdo -O -w -z zip_5  -sellonlatbox,40,100,-10,30 \${merge_file} ${homedir}/test_NUDGE2_selbox_${var}.nc
      cdo -O -w -z zip_5 -fldmean ${homedir}/test_NUDGE2_selbox_${var}.nc \${NIO_file}

      #SubTropical Southern Indian Ocean 20E ~ 120E, -40N ~ -10N
      set STSIO_file = \${SAVE_ROOT}/mean_STSIO_${var}_\${CASENAME}.pop.h.nc
      cdo -O -w -z zip_5  -sellonlatbox,20,120,-40,-10 \${merge_file} ${homedir}/test_NUDGE2_selbox_${var}.nc
      cdo -O -w -z zip_5 -fldmean ${homedir}/test_NUDGE2_selbox_${var}.nc \${STSIO_file}

      #SubPolar Southern Indian Ocean 20E ~ 120E, -60N ~ -40N
      set SPSIO_file = \${SAVE_ROOT}/mean_SPSIO_${var}_\${CASENAME}.pop.h.nc
      cdo -O -w -z zip_5  -sellonlatbox,20,120,-60,-40 \${merge_file} ${homedir}/test_NUDGE2_selbox_${var}.nc
      cdo -O -w -z zip_5 -fldmean ${homedir}/test_NUDGE2_selbox_${var}.nc \${SPSIO_file}
      
      #NiNO3.4 Region  170W ~ 120W, -5N ~ 5N
      set NINO34_file = \${SAVE_ROOT}/mean_NINO34_${var}_\${CASENAME}.pop.h.nc
      cdo -O -w -z zip_5  -sellonlatbox,-170,-120,-5,5 \${merge_file} ${homedir}/test_selbox_${var}.nc
      cdo -O -w -z zip_5 -fldmean ${homedir}/test_selbox_${var}.nc \${NINO34_file}

    end
  end
end
rm -f ${homedir}/test_NUDGE2_sqr_bias_${var}.nc ${homedir}/test_NUDGE2_msqr_bias_${var}.nc
rm -f ${homedir}/test_NUDGE2_selbox_${var}.nc
EOF
