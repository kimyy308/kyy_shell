...
#      set ARC_ROOT = /mnt/lustre/proj/earth.system.predictability/ATM_TEST/preliminary/ATM_NUDGE2_ASSM_EXP/archive/\${CASENAME_M}
      ...
      set merge_file = \${SAVE_ROOT}/merged_${var}_\${CASENAME}.cam.h1.nc
     ...
     # endif
      ...
      set OBS_merge_file = \${OBS_SAVE_ROOT}/merged_${var}_\${OBS_CASENAME}.cam.h1.nc
      set OBS_ck_mfile = \`ls \${OBS_merge_file}\`
     # if ( \${OBS_ck_mfile} == "" ) then
        cdo -O -w -z zip_5 -mergetime \${OBS_input_set} \${OBS_merge_file} 
     # endif
      
      set bias_file = \${SAVE_ROOT}/bias_${var}_\${CASENAME}.cam.h1.nc
      cdo -O -w -z zip_5 -sub \${merge_file} \${OBS_merge_file} \${bias_file}      
      set mbias_file = \${SAVE_ROOT}/mean_bias_${var}_\${CASENAME}.cam.h1.nc
      ...
      set RMSE_file = \${SAVE_ROOT}/RMSE_${var}_\${CASENAME}.cam.h1.nc
      cdo -O -w -z zip_5 -sqrt ${homedir}/test_msqr_bias_${var}.nc \${RMSE_file}
     
        
      ### absolute error field mean
      #ArcTic Ocean 0E ~ 360E(0W), 70N ~ 90N
      set ATO_bias_file = \${SAVE_ROOT}/mean_bias_ATO_${var}_\${CASENAME}.cam.h1.nc
      ...
      set SPNP_bias_file = \${SAVE_ROOT}/mean_bias_SPNP_${var}_\${CASENAME}.cam.h1.nc
      ...
      set STNP_bias_file = \${SAVE_ROOT}/mean_bias_STNP_${var}_\${CASENAME}.cam.h1.nc
      ...
      set TP_bias_file = \${SAVE_ROOT}/mean_bias_TP_${var}_\${CASENAME}.cam.h1.nc
      ...
      set STSP_bias_file = \${SAVE_ROOT}/mean_bias_STSP_${var}_\${CASENAME}.cam.h1.nc
      ...
      set SPSP_bias_file = \${SAVE_ROOT}/mean_bias_SPSP_${var}_\${CASENAME}.cam.h1.nc
      ...
      set ANO_bias_file = \${SAVE_ROOT}/mean_bias_ANO_${var}_\${CASENAME}.cam.h1.nc
      ...
      set SPNA_bias_file = \${SAVE_ROOT}/mean_bias_SPNA_${var}_\${CASENAME}.cam.h1.nc
      ...
      set STNA_bias_file = \${SAVE_ROOT}/mean_bias_STNA_${var}_\${CASENAME}.cam.h1.nc
      ...
      set TA_bias_file = \${SAVE_ROOT}/mean_bias_TA_${var}_\${CASENAME}.cam.h1.nc
      ...
      set STSA_bias_file = \${SAVE_ROOT}/mean_bias_STSA_${var}_\${CASENAME}.cam.h1.nc
      ...
      set SPSA_bias_file = \${SAVE_ROOT}/mean_bias_SPSA_${var}_\${CASENAME}.cam.h1.nc
      ...
      set NIO_bias_file = \${SAVE_ROOT}/mean_bias_NIO_${var}_\${CASENAME}.cam.h1.nc
      ...
      set STSIO_bias_file = \${SAVE_ROOT}/mean_bias_STSIO_${var}_\${CASENAME}.cam.h1.nc
      ...
      set SPSIO_bias_file = \${SAVE_ROOT}/mean_bias_SPSIO_${var}_\${CASENAME}.cam.h1.nc
