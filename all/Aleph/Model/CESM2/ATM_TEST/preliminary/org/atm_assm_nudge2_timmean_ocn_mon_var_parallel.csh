...
#      set ARC_ROOT = /mnt/lustre/proj/earth.system.predictability/ATM_NUDGE2_ASSM_EXP/archive/\${CASENAME_M}
      set ARC_ROOT = /mnt/lustre/proj/earth.system.predictability/ATM_NUDGE2_ASSM_EXP/archive_transfer/ocn/\${outfreq}/${var}/\${CASENAME} 
      set SAVE_ROOT = /mnt/lustre/proj/earth.system.predictability/ATM_NUDGE2_ASSM_EXP/archive_transfer/ocn/\${outfreq}/${var}/\${CASENAME}/MEAN
      set SAVE_RMSE_ROOT = /mnt/lustre/proj/earth.system.predictability/ATM_NUDGE2_ASSM_EXP/archive_transfer/ocn/\${outfreq}/${var}/\${CASENAME}/RMSE
      mkdir -p \$SAVE_ROOT
