...
set vars = ( photoC_TOT photoC_TOT_zint_100m )

foreach var ( ${vars} )

mkdir ~/tmp_script
mkdir ~/tmp_log
set tmp_scr =  ~/tmp_script/RMSE_${var}_atm_NOASSM_assm_tmp.csh
set tmp_log =  ~/tmp_log/RMSE_${var}_atm_NOASSM_assm_tmp.log
...
foreach ENS ( \${ENS_ALL} )
  set CASENAME = LE2-\${ENS}
      ...
      set ARC_ROOT = /mnt/lustre/proj/earth.system.predictability/ATM_TEST/preliminary/ATM_NOASSM_ASSM_EXP/archive_transfer/ocn/\${outfreq}/${var}/\${CASENAME} 
      set SAVE_ROOT = /mnt/lustre/proj/earth.system.predictability/ATM_TEST/preliminary/ATM_NOASSM_ASSM_EXP/archive_transfer/ocn/\${outfreq}/${var}/\${CASENAME}/RMSE
      mkdir -p \$SAVE_ROOT
