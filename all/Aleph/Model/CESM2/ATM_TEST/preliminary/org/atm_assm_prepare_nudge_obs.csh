...
set ARC_ROOT = /mnt/lustre/proj/earth.system.predictability/ATM_ASSM_EXP/archive/b.e21.BSSP370smbb.f09_g17.assm.projdv7.3_ba-10p1/atm/hist

set ARC_FILE_SET = ( `ls ${ARC_ROOT}/*.cam.h2.*` )
set HEAD = b.e21.BSSP370smbb.f09_g17.assm.projdv7.3_ba-10p1
set NUDGE_ROOT = /mnt/lustre/proj/earth.system.predictability/ATM_ASSM_EXP/nudging/analyses/${HEAD}
