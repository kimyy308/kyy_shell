...
#      set ARC_ROOT = /mnt/lustre/proj/earth.system.predictability/ATM_NUDGE2_ASSM_EXP/archive/\${CASENAME_M}
      ...
      set SAVE_ROOT = /mnt/lustre/proj/earth.system.predictability/ATM_NUDGE2_ASSM_EXP/archive_transfer/ocn/\${outfreq}/${var}/\${CASENAME}/RMSE
      mkdir -p \$SAVE_ROOT
      
      set OBS_ROOT = /mnt/lustre/proj/earth.system.predictability/ATM_ASSM_EXP/archive_transfer/ocn/\${outfreq}/${var}/\${OBS_CASENAME}
      set OBS_SAVE_ROOT = /mnt/lustre/proj/earth.system.predictability/ATM_ASSM_EXP/archive_transfer/ocn/\${outfreq}/${var}/\${OBS_CASENAME}/RMSE
