#!/bin/csh
####!/bin/csh -fx
# Updated  06-Apr-2023 by Yong-Yub Kim, e-mail: kimyy308@pusan.ac.kr
...
mkdir ~/tmp_script
mkdir ~/tmp_log
set tmp_scr =  ~/tmp_script/${var}_EXP_ATM_assm_tmp.csh
set tmp_log =  ~/tmp_log/${var}_EXP_ATM_assm_tmp.log
...
foreach OBS ( \${OBS_SET} ) #OBS loop1
  foreach FACTOR ( \$FACTOR_SET ) #FACTOR loop1
    foreach mbr ( \$mbr_set ) #mbr loop1
      ...
      set ARC_ROOT = /mnt/lustre/proj/earth.system.predictability/ATM_TEST/EXP_ATM/archive/\${CASENAME_M}
      set SAVE_ROOT = /mnt/lustre/proj/earth.system.predictability/ATM_TEST/EXP_ATM/archive_transfer/ocn/\${outfreq}/${var}/\${CASENAME} 
      mkdir -p \$SAVE_ROOT
      ...
      foreach inputname ( \${input_set} )
        ...
        cdo -O -w -z zip_5 select,name=${var} \$inputname ${homedir}/test_EXP_ATM_atm_assm_extract_ocn_${var}.nc
        cdo -O -w -z zip_5 -sellevel,500/15000 ${homedir}/test_EXP_ATM_atm_assm_extract_ocn_${var}.nc  \$outputname 
      end
    end
  end
end
end
rm -f ${homedir}/test_EXP_ATM_atm_assm_extract_ocn_${var}.nc
