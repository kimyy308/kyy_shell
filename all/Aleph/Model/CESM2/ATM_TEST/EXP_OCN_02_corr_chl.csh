...
#      set CASENAME_M = b.e21.${scen}.${RESOLN}.assm.${OBS}-${FACTOR}p${mbr}  #parent casename
      ...
      #diatChl
      set ARC_ROOT_diat = /mnt/lustre/proj/earth.system.predictability/ASSM_EXP/archive_transfer/ocn/diatChl/${CASENAME}
      ...
      #diazChl
      set ARC_ROOT_diaz = /mnt/lustre/proj/earth.system.predictability/ASSM_EXP/archive_transfer/ocn/diazChl/${CASENAME}
      ...
      #spChl
      set ARC_ROOT_sp = /mnt/lustre/proj/earth.system.predictability/ASSM_EXP/archive_transfer/ocn/spChl/${CASENAME}
      ...
      #sumChl
      set ARC_ROOT_sum = /mnt/lustre/proj/earth.system.predictability/ASSM_EXP/archive_transfer/ocn/sumChl/${CASENAME}
...
rm -f ${homedir}/merged_diat_chl.nc
rm -f ${homedir}/merged_diaz_chl.nc
rm -f ${homedir}/merged_sp_chl.nc 
rm -f ${homedir}/merged_sum_chl.nc
