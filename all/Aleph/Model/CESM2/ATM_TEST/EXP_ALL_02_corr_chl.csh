...
#      set CASENAME_M = b.e21.${scen}.${RESOLN}.assm.${OBS}-${FACTOR}p${mbr}  #parent casename
      ...
      #diatChl
      set ARC_ROOT_diat = /mnt/lustre/proj/earth.system.predictability/ATM_TEST/EXP_ALL/archive_transfer/ocn/${outfreq}/diatChl/${CASENAME}
      set SAVE_ROOT_diat = ${ARC_ROOT_diat} 
      mkdir -p ${SAVE_ROOT_diat}/link
      mkdir -p $SAVE_ROOT_diat
      mkdir -p ${SAVE_ROOT_diat}/merged
      ln -sf ${ARC_ROOT_diat}/b.e21.diatChl_${outfreq}_${CASENAME}.pop.h.${year}-${month}.nc ${SAVE_ROOT_diat}/link/
      
      #diazChl
      set ARC_ROOT_diaz = /mnt/lustre/proj/earth.system.predictability/ATM_TEST/EXP_ALL/archive_transfer/ocn/${outfreq}/diazChl/${CASENAME}
      set SAVE_ROOT_diaz = ${ARC_ROOT_diaz} 
      mkdir -p ${SAVE_ROOT_diaz}/link
      mkdir -p $SAVE_ROOT_diaz
      mkdir -p ${SAVE_ROOT_diaz}/merged
      ln -sf ${ARC_ROOT_diaz}/b.e21.diazChl_${outfreq}_${CASENAME}.pop.h.${year}-${month}.nc ${SAVE_ROOT_diaz}/link/
      
      #spChl
      set ARC_ROOT_sp = /mnt/lustre/proj/earth.system.predictability/ATM_TEST/EXP_ALL/archive_transfer/ocn/${outfreq}/spChl/${CASENAME}
      set SAVE_ROOT_sp = ${ARC_ROOT_sp} 
      mkdir -p ${SAVE_ROOT_sp}/link
      mkdir -p $SAVE_ROOT_sp
      mkdir -p ${SAVE_ROOT_sp}/merged
      ln -sf ${ARC_ROOT_sp}/b.e21.spChl_${outfreq}_${CASENAME}.pop.h.${year}-${month}.nc ${SAVE_ROOT_sp}/link/

      #sumChl
      set ARC_ROOT_sum = /mnt/lustre/proj/earth.system.predictability/ATM_TEST/EXP_ALL/archive_transfer/ocn/${outfreq}/sumChl/${CASENAME}
      set SAVE_ROOT_sum = ${ARC_ROOT_sum} 
      mkdir -p ${SAVE_ROOT_sum}/link
      mkdir -p $SAVE_ROOT_sum
      mkdir -p ${SAVE_ROOT_sum}/merged
#      cdo -O -w -z zip_5 -merge -selname,diatChl ${ARC_ROOT_diat}/b.e21.diatChl_${outfreq}_${CASENAME}.pop.h.${year}-${month}.nc -selname,diazChl ${ARC_ROOT_diaz}/b.e21.diazChl_${outfreq}_${CASENAME}.pop.h.${year}-${month}.nc ${ARC_ROOT_sp}/b.e21.spChl_${outfreq}_${CASENAME}.pop.h.${year}-${month}.nc ${homedir}/merged_chl.nc
#      cdo -O -w -z zip_5 -expr,'sumChl=diatChl+diazChl+spChl;' ${homedir}/merged_chl.nc ${ARC_ROOT_sum}/b.e21.sumChl_${outfreq}_${CASENAME}.pop.h.${year}-${month}.nc 
      ln -sf ${ARC_ROOT_sum}/b.e21.sumChl_${outfreq}_${CASENAME}.pop.h.${year}-${month}.nc ${SAVE_ROOT_sum}/link/
...
cdo -O -w -z zip_5 -sellevel,500 -mergetime ${SAVE_ROOT_diat}/link/b.e21* ${SAVE_ROOT_diat}/merged/merged_diatChl_${CASENAME}_${siy}_${eiy}.nc
cdo -O -w -z zip_5 -sellevel,500 -mergetime ${SAVE_ROOT_diaz}/link/b.e21* ${SAVE_ROOT_diaz}/merged/merged_diazChl_${CASENAME}_${siy}_${eiy}.nc
cdo -O -w -z zip_5 -sellevel,500 -mergetime ${SAVE_ROOT_sp}/link/b.e21* ${SAVE_ROOT_sp}/merged/merged_spChl_${CASENAME}_${siy}_${eiy}.nc
cdo -O -w -z zip_5 -sellevel,500 -mergetime ${SAVE_ROOT_sum}/link/b.e21* ${SAVE_ROOT_sum}/merged/merged_sumChl_${CASENAME}_${siy}_${eiy}.nc
cdo -O -w -z zip_5 mergetime ${OBS_ROOT}/link/OC_CCI* ${OBS_ROOT}/merged/merged_${siy}_${eiy}.nc

#mergetime, vertical average
cdo -O -w -z zip_5 -vertmean -mergetime ${SAVE_ROOT_diat}/link/b.e21* ${SAVE_ROOT_diat}/merged/vm_merged_diatChl_${CASENAME}_${siy}_${eiy}.nc
cdo -O -w -z zip_5 -vertmean -mergetime ${SAVE_ROOT_diaz}/link/b.e21* ${SAVE_ROOT_diaz}/merged/vm_merged_diazChl_${CASENAME}_${siy}_${eiy}.nc
cdo -O -w -z zip_5 -vertmean -mergetime ${SAVE_ROOT_sp}/link/b.e21* ${SAVE_ROOT_sp}/merged/vm_merged_spChl_${CASENAME}_${siy}_${eiy}.nc
cdo -O -w -z zip_5 -vertmean -mergetime ${SAVE_ROOT_sum}/link/b.e21* ${SAVE_ROOT_sum}/merged/vm_merged_sumChl_${CASENAME}_${siy}_${eiy}.nc
