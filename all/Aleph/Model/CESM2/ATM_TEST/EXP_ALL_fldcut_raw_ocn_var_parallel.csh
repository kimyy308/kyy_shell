#!/bin/csh
####!/bin/csh -fx
# Updated  19-Mar-2025 by Yong-Yub Kim, e-mail: kimyy308@pusan.ac.kr
...
#set SAVE_ROOT = /mnt/lustre/proj/earth.system.predictability/ATM_TEST/archive_transfer/EXP_ALL/${comp}/${var}/ens_all/${REGION}
#mkdir -p \${SAVE_ROOT}
...
foreach mbr ( \${mbr_set} ) #mbr loop
    ...
    set ARC_ROOT = /mnt/lustre/proj/earth.system.predictability/ATM_TEST/EXP_ALL_timeseries/archive/\${CASENAME_M}/${comp}/proc/tseries/month_1
    set SAVE_ROOT = /mnt/lustre/proj/kimyy/tr_sysong/fld/ATM_TEST/EXP_ALL/archive/\${CASENAME_M}/${comp}
    mkdir -p \${SAVE_ROOT}
