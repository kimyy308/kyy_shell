...
foreach iyloop ( ${IY_SET} )  # iy loop1, inverse direction
  set INITY = ${iyloop}
#  setenv ARC_ROOT /mnt/lustre/proj/kimyy/Model/CESM2/ESP/HCST_EXP/archive/atm/${var}/ens_all/ens_all_i${iyloop}
#  setenv SAVE_ROOT /mnt/lustre/proj/kimyy/Model/CESM2/ESP/HCST_EXP/archive/atm/${var}/ens_all/ens_all_i${iyloop}/${region}
  setenv ARC_ROOT /mnt/lustre/proj/earth.system.predictability/HCST_EXP/archive_transfer/atm/${var}/ens_all/ens_all_i${iyloop}
  setenv SAVE_ROOT /mnt/lustre/proj/earth.system.predictability/HCST_EXP/archive_transfer/atm/${var}/ens_all/ens_all_i${iyloop}/${region}
 ...
 # set outputnc_new=(`echo ${outputnc} | sed "s/${RESOLN}/${var}_${RESOLN}/g"`)
  ...
  foreach fy ( ${FY_SET} )
    foreach mon ( ${M_SET} )
      ...
      set inputname=${ARC_ROOT}/${var}_${RESOLN}.hcst.ensmean_all_i${iyloop}.cam.h0.${fy}-${mon}.nc
      set outputname1=${SAVE_ROOT}/${region}_${var}_${RESOLN}.hcst.ensmean_all_i${iyloop}.cam.h0.${fy}-${mon}.nc
      set outputname2=${SAVE_ROOT}/M_${region}_${var}_${RESOLN}.hcst.ensmean_all_i${iyloop}.cam.h0.${fy}-${mon}.nc
#      echo "cdo -O fldmean "${input_set} ${outputname}
      if ( ${var} == TS & ${fy} < 2022 ) then
        ...
        cdo -O -sellonlatbox,${xs},${xe},${ys},${yn} ${homedir}/TS_merge.nc ~/test.nc
