...
set mem = `cat mem_name`
  ...
  foreach vname1 ( $vnames1 )
   rm -f /mnt/lustre/proj/earth.system.predictability/HCST_EXP_timeseries/archive/*f09_g17.hcst.${mem}/f09_g17.hcst.${mem}_i${iyear}/ice/proc/tseries/day_1/*.$vname1.*.nc
  end
  ...
  set vnames2 = ( aicen albsni alidf_ai alidr_ai alvdf_ai\
		...
		sidmassgrowthbot sidmassgrowthwat sidmasslat sid.hcst.ltbot sid.hcst.lttop\
		...
		snd.hcst.lt sndmasssnf sndmassubl snowfrac uatm\
  ...
  foreach vname2 ( $vnames2 )
   rm -f /mnt/lustre/proj/earth.system.predictability/HCST_EXP_timeseries/archive/*f09_g17.hcst.${mem}/f09_g17.hcst.${mem}_i${iyear}/ice/proc/tseries/month_1/*.$vname2.*.nc
  end
