...
foreach iyloop ( \${IY_SET} )
  ...
  set SAVE_ROOT = /mnt/lustre/proj/earth.system.predictability/HCST_EXP_timeseries/archive_ensmean/ENSMEAN_i\${INITY}/atm/month_1
  set ARC_TS_ROOT = /mnt/lustre/proj/earth.system.predictability/HCST_EXP_timeseries/archive/\*/\*i\${INITY}/atm/proc/tseries/month_1
  ...
  cdo -s -O -L -w -z zip_5 ensmean \
    \$TMPDIR/*.nc \
    \$SAVE_ROOT/f09_g17.hcst.ENSMEAN_i\${INITY}.cam.h0.${var}.\${INITY}01-\${fy_end}12.nc
