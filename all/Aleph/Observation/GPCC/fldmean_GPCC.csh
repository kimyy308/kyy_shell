...
foreach iyloop ( ${IY_SET} )  # iy loop1, inverse direction
  ...
  setenv SAVE_ROOT /mnt/lustre/proj/kimyy/Observation/GPCC/monthly_reg_cam/${region}
 ...
 # set outputnc_new=(`echo ${outputnc} | sed "s/${RESOLN}/${var}_${RESOLN}/g"`)
  ...
  foreach mon ( ${M_SET} )
    ...
    set inputname=${GPCC_ROOT}/GPCC_reg_cesm2.v5.${iyloop}${mon}.nc
    set outputname1=${SAVE_ROOT}/${region}_GPCC_reg_cesm2.v5.${iyloop}${mon}.nc
    set outputname2=${SAVE_ROOT}/M_${region}_GPCC_reg_cesm2.v5.${iyloop}${mon}.nc
