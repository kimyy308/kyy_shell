...
foreach iyloop ( ${IY_SET} )  # iy loop1, inverse direction
  ...
  setenv SAVE_ROOT /mnt/lustre/proj/kimyy/Observation/GFED/FIRE_CLOSS/monthly_reg_5deg
...
#  cdo -w -z zip_5 -monmean ${input} ${output1}
  ...
  foreach mon ( ${M_SET} )
    set output2 = ${SAVE_ROOT}/FIRE_CLOSS_reg_5deg.${iyloop}${mon}.nc 
    cdo -O -L -selmon,${mon} -selyear,${iyloop} ${output1} /proj/kimyy/tmp/test_FIRE_CLOSS.nc
    cdo -O remapbil,r72x36 /proj/kimyy/tmp/test_FIRE_CLOSS.nc ${output2}
  end
end
