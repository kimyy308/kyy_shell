...
foreach iyloop ( ${IY_SET} )  # iy loop1, inverse direction
  set INITY = ${iyloop}
  setenv CMEMS_ROOT /mnt/lustre/proj/kimyy/Observation/CMEMS/GlobColour/CHL
  setenv SAVE_ROOT /mnt/lustre/proj/kimyy/Observation/CMEMS/GlobColour/monthly_reg_pop/CHL
  mkdir -p $SAVE_ROOT
  foreach mon ( ${M_SET} )
    ...
    set input = ${CMEMS_ROOT}/${INITY}/GLob_Chl_${iyloop}-${mon}.nc 
