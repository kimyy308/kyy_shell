...
foreach iyloop ( ${IY_SET} )  # iy loop1, inverse direction
  set INITY = ${iyloop}
  setenv CMEMS_ROOT /Volumes/kyy_raid/kimyy/Observation/CMEMS/GlobColour/PP
  setenv SAVE_ROOT /Volumes/kyy_raid/kimyy/Observation/CMEMS/GlobColour/monthly_reg_pop/PP
  mkdir -p $SAVE_ROOT
  foreach mon ( ${M_SET} )
