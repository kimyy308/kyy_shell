...
#  set outdir = /Volumes/kyy_raid/kimyy/Observation/CMEMS/GlobColour/CHL/${year}
  set outdir = /mnt/lustre/proj/kimyy/Observation/CMEMS/GlobColour/PP/${year}
  mkdir -p $outdir
  foreach mon ( $months )
      ...
      copernicusmarine subset --dataset-id cmems_obs-oc_glo_bgc-pp_my_l4-multi-4km_P1M --variable PP --variable PP_uncertainty --variable flags --start-datetime ${year}-${mon}-01T00:00:00 --end-datetime ${year}-${mon}-01T00:00:00 --minimum-longitude -179.99722290039062 --maximum-longitude 179.9972381591797 --minimum-latitude -89.99722290039062 --maximum-latitude 89.99722290039062 --output-filename ${year}-${mon}.nc --output-directory ${outdir} --username ykim7 --password Qp1al2zm3!
  end
end
