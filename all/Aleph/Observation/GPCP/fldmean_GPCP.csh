...
foreach iyloop ( ${IY_SET} )  # iy loop1, inverse direction
  set INITY = ${iyloop}
  setenv GPCP_ROOT /mnt/lustre/proj/kimyy/Observation/GPCP/monthly_reg_cam
  setenv SAVE_ROOT /mnt/lustre/proj/kimyy/Observation/GPCP/monthly_reg_cam/${region}
 ...
 # set outputnc_new=(`echo ${outputnc} | sed "s/${RESOLN}/${var}_${RESOLN}/g"`)
  ...
  foreach mon ( ${M_SET} )
    ...
    set inputname=${GPCP_ROOT}/GPCP_reg_cesm2.v5.${iyloop}${mon}.nc
    set outputname1=${SAVE_ROOT}/${region}_GPCP_reg_cesm2.v5.${iyloop}${mon}.nc
    set outputname2=${SAVE_ROOT}/M_${region}_GPCP_reg_cesm2.v5.${iyloop}${mon}.nc
